...
question_form = ExternalQuestion(external_url='https://cocosci.berkeley.edu:8000/', frame_height=800)
keywords=['boto', 'test', 'doctest']
create_hit_rs = mtc.create_hit(question=question_form, max_assignments=10,title="Categorization Experiment 2", keywords=keywords,reward = 0.05, duration=60*6,approval_delay=60*60)
